            ...
            <div class="form-container">
                ...
                <form action="{{ route('agenda.reschedule.update', $agenda->id) }}" method="POST" class="p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control readonly-field" name="jam"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control readonly-field" name="tempat"
                            value="{{ $agenda->tempat }}" readonly />
                    </div>

                    <div class="mb-3">
                        <label for="status_reschedule" class="form-label">Status (Reschedule)</label>
                        <input type="text" class="form-control readonly-field" name="status_reschedule"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="status" required>
                            ...
                            <option value="confirmed" {{ $agenda->status == 'confirmed' ? 'selected' : '' }}>Confirmed
                            </option>
